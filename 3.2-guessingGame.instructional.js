...
function checkGuess() {
    ...
    if (myGuess == randomNumber) {
       alert("Your guess was" + myGuess +  ". Are you a mind reader? Nice!");
    } else if (myGuess > randomNumber) {
        alert("Your guess was"  +   myGuess  +  ". Maybe don't start a psychic network just yet...give it another shot!");
    } else if(myGuess < randomNumber) {
        alert("Your guess was"  +  myGuess  + ". Maybe don't start a psychic network just yet...try again");
    }
    }
enterSubmit.addEventListener('click' , checkGuess)